...
public class MessageProcessor implements APIResultCallBack {
	...
	public void performOperation(String response) {
		try {
			...
			if (Constants.DEBUG_MODE_ENABLED) {
				Log.d(TAG, "JSON Exception in response String." + e.toString());
			}
		}
	...
	public void getMessages() {
		...
		try {
			...
			if (Constants.DEBUG_MODE_ENABLED) {
				Log.d(TAG, "Unsupport encoding." + e.toString());
			}
		}
		...
		CommonUtils.callSecuredAPI(context, utils.getAPIServerURL() +
		                                    ...
		                                    deviceIdentifier,
		                           Constants.GET_METHOD, new JSONObject(), MessageProcessor.this,
