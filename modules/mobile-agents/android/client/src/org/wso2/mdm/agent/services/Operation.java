...
public class Operation {
	 ...
	 * @param operation - Operation object.
	 */
	public void getLocationInfo(org.wso2.mdm.agent.beans.Operation operation) throws AndroidAgentException {
		double latitude;
		double longitude;
		JSONObject result = new JSONObject();
	 ...
	 * @param operation - Operation object.
	 */
	public void getApplicationList(org.wso2.mdm.agent.beans.Operation operation) throws AndroidAgentException {
	 ...
	 * @param operation - Operation object.
	 */
	public void lockDevice(org.wso2.mdm.agent.beans.Operation operation) {
	 ...
	 * @param operation - Operation object.
	 */
	public void ringDevice(org.wso2.mdm.agent.beans.Operation operation) {
	 ...
	 * @param operation - Operation object.
	 */
	public void wipeDevice(org.wso2.mdm.agent.beans.Operation operation) throws AndroidAgentException {
		String inputPin;
		String savedPin =
	 ...
	 * @param operation - Operation object.
	 */
	public void clearPassword(org.wso2.mdm.agent.beans.Operation operation) {
	 ...
	 * @param operation - Operation object.
	 */
	public void displayNotification(org.wso2.mdm.agent.beans.Operation operation) throws AndroidAgentException {
	 ...
	 * @param operation - Operation object.
	 */
	public void configureWifi(org.wso2.mdm.agent.beans.Operation operation) throws AndroidAgentException {
		boolean wifiStatus;
		String ssid = null;
	 ...
	 * @param operation - Operation object.
	 */
	public void disableCamera(org.wso2.mdm.agent.beans.Operation operation) throws AndroidAgentException {
	 ...
	 * @param operation - Operation object.
	 */
	public void installAppBundle(org.wso2.mdm.agent.beans.Operation operation) throws AndroidAgentException {
		try {
			operation.setStatus(resources.getString(R.string.operation_value_completed));
			resultBuilder.build(operation);
	 ...
	 * @param operation - Operation object.
	 */
	public void uninstallApplication(org.wso2.mdm.agent.beans.Operation operation) throws AndroidAgentException {
		String packageName;
		try {
			JSONObject appData = new JSONObject(operation.getPayLoad().toString());
	 ...
	 * @param operation - Operation object.
	 */
	public void encryptStorage(org.wso2.mdm.agent.beans.Operation operation) throws AndroidAgentException {
	 ...
	 * @param operation - Operation object.
	 */
	private void muteDevice(org.wso2.mdm.agent.beans.Operation operation) {
		operation.setStatus(resources.getString(R.string.operation_value_completed));
		resultBuilder.build(operation);
	 ...
	 * @param operation - Operation object.
	 */
	public void setPasswordPolicy(org.wso2.mdm.agent.beans.Operation operation) throws AndroidAgentException {
		ComponentName demoDeviceAdmin = new ComponentName(context, AgentDeviceAdminReceiver.class);
	 ...
	 * @param operation - Operation object.
	 */
	public void installGooglePlayApp(org.wso2.mdm.agent.beans.Operation operation) throws AndroidAgentException {
		String packageName;
		try {
			JSONObject appData = new JSONObject(operation.getPayLoad().toString());
	 ...
	 * @param operation - Operation object.
	 */
	public void changeLockCode(org.wso2.mdm.agent.beans.Operation operation) throws AndroidAgentException {
		ComponentName demoDeviceAdmin = new ComponentName(context, AgentDeviceAdminReceiver.class);
	 ...
	 * @param operation - Operation object.
	 */
	public void enterpriseWipe(org.wso2.mdm.agent.beans.Operation operation) {
	 ...
	 * @param operation - Operation object.
	 */
	public void blacklistApps(org.wso2.mdm.agent.beans.Operation operation) throws AndroidAgentException {
		ArrayList<DeviceAppInfo> apps = new ArrayList<>(appList.getInstalledApps().values());
	 ...
	 */
	private void installApplication(JSONObject data) throws AndroidAgentException {
		String appUrl;
		String type = null;

		try {
			appUrl = (String) data
					.get(resources.getString(R.string.app_url));
			if (!data.isNull(resources.getString(R.string.app_type))) {
				type = (String) data
						.get(resources.getString(R.string.app_type));
			}
